...
class QobuzApi:
    ...
    def play_favorites(self, favorite_type=None, limit=2):
        if favorite_type:
        ...
        favorites_url = 'http://www.qobuz.com/api.json/0.2/favorite/getUserFavorites?&limit={limit}{params_type}'.format_map(params)
